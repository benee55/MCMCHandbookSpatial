...
####################################
setwd("~/Nonstationary/RevisionMaterials/Code/Precip/run/run_bisquare/")
...
load("/scratch/slee287/precip/bisquare/mcmcPrecip56k.RData")
...
save(rmspe,predCV,file="/scratch/slee287/precip/bisquare/results.RData")
